...
+ (void)showImage:(UIImage*)image status:(NSAttributedString*)status; // use 50x50 white pngs
+ (void)showImage:(UIImage*)image status:(NSAttributedString*)status duration:(NSTimeInterval)duration; // use 50x50 white pngs
