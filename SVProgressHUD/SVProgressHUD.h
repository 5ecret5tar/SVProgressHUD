...
+ (void)showImage:(UIImage*)image status:(id)status; // use 50x50 white pngs
+ (void)showImage:(UIImage*)image status:(id)status duration:(NSTimeInterval)duration; // use 50x50 white pngs
